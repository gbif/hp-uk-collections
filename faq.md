...
The programme is funded through the UK Research and Innovation (UKRI) infrastructure fund and led by the Arts and Humanities Research Council (AHRC), working in partnership with the Natural History Museum. DiSSCo UK is one part of a wider [£473 million investment from UKRI](https://www.ukri.org/news/major-research-and-innovation-infrastructure-investment-announced/) investing in world-class facilities, equipment, and resources that are essential for researchers and innovators to do ground-breaking work. In March 2024, [the Government announced DiSSCo UK](https://www.nhm.ac.uk/press-office/press-releases/natural-history-museum-to-lead-new-national-programme-to-digitis.html), subject to business case approvals, and in June 2026 the programme was officially approved, with the programme officially announced in July 2026. 
...
+ A beta [DiSSCo UK data access repository](https://dissco-uk.org) underpinned by GBIF, aggregating >18 million records [as of July 2026]. 
+ An instance of the [Integrated Publishing Toolkit (IPT)](https://ipt.dissco-uk.org/) alongside supporting documentation to support organisations publishing their data to GBIF. 
...
+ Promotional and communications materials including a [Blueprint](https://dissco-uk.org/assets/Harnessing%20the%20Power%20of%20Natural%20Science%20Collections.pdf) to outline the need for a national programme, and a [Science Review](https://dissco-uk.org/assets/DiSSCo%20UK%20Year%200%20Science%20Review.pdf) to promote the impact of UK digitised collections.  
...
+ Digitising UK natural science collections is expected to [generate research and economic benefit for the UK over 30 years](https://riojournal.com/article/78844/), across areas like conservation, invasive species, agricultural research and development, medicines discovery and mineral extraction.  
...
+ UK Collections data are in demand. In 2022 on average [more than 2 research publications per day cited NHM collections data](https://riojournal.com/article/113378/). DiSSCo UK will vastly expand the scale of data available and increase its visibility and impact.  
...
Many resources, including the programme blueprint, promotional video, news and case studies, and the UK collections dashboard, are available on the [resources](https://dissco-uk.org/resources/) page on this website.  
...
We retain recordings of our community events. If you would like to access these recordings, please contact us at [dissco-uk@nhm.ac.uk](mailto:dissco-uk@nhm.ac.uk). 
...
You can find guides for workflows and best practice [here](https://dissco.github.io/). As you generate data, aligning with the [Darwin Core standard](https://dwc.tdwg.org/) will simplify the publishing process later. Further guidance will be provided with each funding call. 
...
Digitised data will be free, open and accessible through the national data portal and [GBIF](https://www.gbif.org/). Support will be available for partners in publishing data to the portal via GBIF’s [Integrated Publishing Toolkit](https://www.gbif.org/ipt).  
